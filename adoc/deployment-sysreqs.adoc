...
Besides the {suse} provided packages and containers, {productname} uses a couple of elements that are provided by third parties and must be downloaded by {kube}.
...
Upstream / Third-Party resources
